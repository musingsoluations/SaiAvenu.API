...
{
    public class
        GetCollectionPaymentQueryHandler : IRequestHandler<GetCollectionPaymentQuery, ErrorOr<List<ChartDataItem>>>
    {
        //private readonly IRepository<FeeCollectionEntity> _feeCollectionRepo;
        private readonly IUnitOfWork _unitOfWork;

        public GetCollectionPaymentQueryHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }


        public async Task<ErrorOr<List<ChartDataItem>>> Handle(GetCollectionPaymentQuery request,
